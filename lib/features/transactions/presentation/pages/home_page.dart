...
class _HomePageBodyState extends State<_HomePageBody> {
  TransactionState? _lastKnownState;

  @override
  Widget build(BuildContext context) {
    return BlocSelector<TransactionBloc, TransactionState, TransactionState>(
      selector: (state) {
        if (state is InvoiceProcessing ||
            state is InvoiceProcessingSuccess ||
            state is InvoiceProcessingError) {
          return _lastKnownState ?? const TransactionLoading();
        }
        _lastKnownState = state;
        return state;
      },
      builder: (context, state) {
        developer.log('_HomePageBody builder state: ${state.runtimeType}',
            name: 'HomePage');
            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                ...
                return TransactionListItem(
                  ...
                  onDelete: () => widget.onDeleteTransaction(transaction),
                );
              },
